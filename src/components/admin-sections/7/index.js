      ...
      <AdminSection className="Admin-section-7">
        <AdminSectionColumn>
          <AdminSectionRow>
            ...
            <ShortButton {...level("109")}>
              <Index>109</Index>
              <Title size="large" brief>va</Title>
              <Score levelId="109"/>
            </ShortButton>
            <ShortButton {...level("110")}>
              <Index>110</Index>
              <Title size="large" brief>ve</Title>
              <Score levelId="110"/>
            </ShortButton>
            <ShortButton {...level("111")}>
              <Index>111</Index>
              <Title size="large" brief>vi</Title>
              <Score levelId="111"/>
            </ShortButton>
            <ShortButton {...level("112")}>
              <Index>112</Index>
              <Title size="large" brief>vo</Title>
              <Score levelId="112"/>
            </ShortButton>
            <ShortButton {...level("113")} review>
              <Index>113</Index>
              <Title size="medium" brief>Review<br/><Letter size="large">v</Letter></Title>
              <Score levelId="113"/>
            </ShortButton>
          </AdminSectionRow>
          <AdminSectionRow>
            ...
            <ShortButton {...level("114")}>
              <Index>114</Index>
              <Title size="large" brief>wa</Title>
              <Score levelId="114"/>
            </ShortButton>
            <ShortButton {...level("115")}>
              <Index>115</Index>
              <Title size="large" brief>we</Title>
              <Score levelId="115"/>
            </ShortButton>
            <ShortButton {...level("116")}>
              <Index>116</Index>
              <Title size="large" brief>wi</Title>
              <Score levelId="116"/>
            </ShortButton>
            <ShortButton hidden/>
            <ShortButton {...level("117")} review>
              <Index>117</Index>
              <Title size="medium" brief>Review<br/><Letter size="large">w</Letter></Title>
              <Score levelId="117"/>
            </ShortButton>
          </AdminSectionRow>
          <AdminSectionRow>
            ...
            <ShortButton {...level("121")} review>
              <Index>121</Index>
              <Title size="medium" brief>Review<br/><Letter size="large">y<Dash/>z</Letter></Title>
              <Score levelId="121"/>
            </ShortButton>
          </AdminSectionRow>
        </AdminSectionColumn>
        ...
        <AdminSectionColumn>
          <ShortButton {...level("122")} assessment>
            <Index>122</Index>
            <Title size="medium" brief>Coarticulation Assessment<br/><Letter size="large">b<Dash/>z</Letter></Title>
            <Score levelId="122"/>
          </ShortButton>
        </AdminSectionColumn>
      </AdminSection>
