...
export default class Lesson extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      choices: {
        hop: {word: "hop", hidden: true},
        box: {word: "box", hidden: true},
        rock: {word: "rock", hidden: true}
      }
    };
  }
  ...
  render() {
    ...
    return (
      <GameScreen owl={owl} onOwlClick={::this.animate}>
        <LessonTitle>Find the Sound - Short o</LessonTitle>
        <LessonTitle.SubTitle>Lesson 11</LessonTitle.SubTitle>
