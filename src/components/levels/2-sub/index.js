...
import Lesson2Sub from "./lesson";
import Activity from "./activity";
import LevelFeedback from "components/levels/2/feedback";
...
export default function({
  ...
  class SubLevel extends React.Component {
    ...
    componentDidMount() {
      this.saveGlobal({lastLevel: `2-${phonic}`});
    }
    ...
    render() {
      ...
      if(showScore && activitiesComplete) {
        return (<LevelFeedback onComplete={() => hasher.setHash("level/3")}/>);
      }
