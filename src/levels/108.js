...
export default multiConsonantReview({
  ...
  activities: [
    ...
    {word: "pot", letters: ["bo", "po", "do"], correctLetters: "po", wordsOnly: true},
    ...
    {word: "hammer", letters: ["ra", "ma", "ha"], correctLetters: "ha", wordsOnly: true},
    {word: "monitor", letters: ["no", "mo", "ro"], correctLetters: "mo", wordsOnly: true},
    {word: "ribbon", letters: ["ni", "hi", "ri"], correctLetters: "ri", wordsOnly: true},
    {word: "castle", letters: ["la", "ca", "sa"], correctLetters: "ca", wordsOnly: true},
