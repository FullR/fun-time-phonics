...
export default consonantVowelReview({
  ...
  activities: [
    ...
    {word: "nozzle", letters: ["nu", "no", "na"], correctLetters: "no", wordsOnly: true},
    {word: "nun", letters: ["nu", "no", "ni"], correctLetters: "nu", wordsOnly: true},
    {word: "nab", letters: ["no", "na", "ne"], correctLetters: "na", wordsOnly: true},
    {word: "nickel", letters: ["nu", "ne", "ni"], correctLetters: "ni", wordsOnly: true},
